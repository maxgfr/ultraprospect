 ...
 *
 * Lives here because four renderers need it — the CSV, the fact sheet, the
 * report and the page — and three of them had grown their own copy.
 */
export function streetLine(a: PostalAddress): string {
