...
//
// The version is duplicated in package.json, src/version.ts (the value the
// bundle embeds) and SKILL.md frontmatter; semantic-release computes it from the
...
// skills/ultraprospect/SKILL.md — the indented `version:` under the frontmatter
...
edit("skills/ultraprospect/SKILL.md", (s) => s.replace(/(\n[ \t]+version:[ \t]*)[^\n]+/, `$1${version}`));

console.log(`sync-version: set ${version} in package.json, src/version.ts, skills/ultraprospect/SKILL.md`);
